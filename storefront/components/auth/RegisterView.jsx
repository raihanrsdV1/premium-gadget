...
export default function RegisterView() {
  ...
  return (
    <div className="container relative flex min-h-[80vh] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 py-10">
      <Link href="/" className="absolute left-4 top-4 md:left-8 md:top-8 flex items-center text-sm font-medium text-muted-foreground hover:text-foreground transition-colors z-20">
      ...
      <div className="lg:p-8 w-full max-w-[450px] mx-auto order-2 lg:order-1 mt-8 lg:mt-0">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[380px]">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="underline underline-offset-4 hover:text-primary font-medium">Sign in</Link>
          </p>
        </div>
      </div>
