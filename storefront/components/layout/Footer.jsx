...
// Ported from frontend/src/components/layout/Footer.jsx (react-router -> next/link).
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-4 leading-relaxed">
              Bangladesh's most trusted destination for premium laptops,
              accessories, and expert repair services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/repairs" className="hover:text-primary transition-colors">Repair Services</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/repairs/track" className="hover:text-primary transition-colors">Track Repair</Link></li>
